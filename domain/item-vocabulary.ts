...
export const ITEM_TYPES = [
  ...
  // Items that are not blocks, and never will be.
  'stick',
  'glowstone_dust',
  'wooden_pickaxe',

  // Added for mc-sim's recipe table, each with a kernel-side reason. The two
  // this repository uses the roster for are in this group.
  'coal',
  'iron_ingot',
  'flint',
  'gunpowder',
