...
export const USAGE: ReadonlyArray<string> = [
  ...
  '    1-9 / 0       air stone sand gravel water lava obsidian door nether_portal fire',
  ...
  '                  roster, and it is the same fact that keeps mushrooms, sugar cane',
  '                  and cactus off the hotbar although all three have placement rules.',
  '                  door is the one per-block rule you can reach: it fills TWO cells',
